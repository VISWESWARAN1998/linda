...
import { Avatar, Container, Flex, Heading, Box, Text, Card } from "@chakra-ui/react";
...
const ChatWindow = () => {
    ...
    if(messages.length === 0) {
        return (
            <Flex height={"100%"} justifyContent={"center"} alignItems={"center"} flexDir={"column"} gap={3}>
                <Avatar.Root size={"2xl"}>
                    <Avatar.Image src="/brain.png" />
                </Avatar.Root>
                <Heading fontSize={"2xl"}>This is the beginning of something amazing!</Heading>
            </Flex>
        )
    }
